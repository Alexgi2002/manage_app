...
int _userEstimateSize(
  ...
  bytesCount += 3 + object.rol.name.length * 3;
  return bytesCount;
}
...
void _userSerialize(
  ...
  writer.writeString(offsets[2], object.rol.name);
}
...
User _userDeserialize(
  ...
  final object = User(
    ...
    rol: _UserrolValueEnumMap[reader.readStringOrNull(offsets[2])] ??
        Rol.asignador,
  );
  object.id = id;
  return object;
...
P _userDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readString(offset)) as P;
    case 2:
      return (_UserrolValueEnumMap[reader.readStringOrNull(offset)] ??
          Rol.asignador) as P;
    default:
...
const _UserrolEnumValueMap = {
  r'asignador': r'asignador',
  r'repartidor': r'repartidor',
  r'cliente': r'cliente',
};
const _UserrolValueEnumMap = {
  r'asignador': Rol.asignador,
  r'repartidor': Rol.repartidor,
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolEqualTo(
    Rol value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolGreaterThan(
    Rol value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolLessThan(
    Rol value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolBetween(
    Rol lower,
    Rol upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'rol',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'rol',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'rol',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> rolIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'rol',
        value: '',
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByRol() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rol', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByRolDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByRol() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rol', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByRolDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rol', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByRol(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, Rol, QQueryOperations> rolProperty() {
    return QueryBuilder.apply(this, (query) {
