...
class MyDio{
  final Dio _dio = Dio(
    BaseOptions(
      baseUrl: 'https://67a54225c0ac39787a1ddd1c.mockapi.io/api/v1'
    )
  );
  ...
  Future<Map<String, dynamic>> request({
    ...
    try {
      ...
      return (response.data is String) ? jsonDecode(response.data) : (response.data is List) ? {'data' : response.data} : response.data;
